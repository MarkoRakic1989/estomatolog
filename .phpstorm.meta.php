...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\bookapp\public\storage' => 'string',
...
'isAdmin','isClient','before','update','delete',
...
'filesystems.links.C:\\xampp\\htdocs\\bookapp\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','image.driver','image.options.autoOrientation',
'image.options.decodeAnimation','image.options.blendingColor','image.options.strip','sanctum.stateful','sanctum.guard',
...
'signed','throttle','verified','check.salon.membership','role',
'permission',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','public.home','public.services','public.about',
'public.contact','api.contact.send','booking.step1','booking.step2.show','booking.step2',
'booking.step3.form','booking.slots','api.calendar.dates','api.calendar.slots','booking.confirm',
'booking.confirmation','booking.confirm.status','admin.salon.index','admin.salon.create','admin.salon.store',
'admin.salon.show','admin.salon.edit','admin.salon.update','admin.salon.destroy','admin.user.index',
'admin.user.create','admin.user.store','admin.user.show','admin.user.edit','admin.user.update',
'admin.user.destroy','admin.billing.index','admin.billing.extend','admin.stats.index','admin.message.index',
'admin.message.create','admin.message.store','admin.message.show','admin.message.destroy','owner.dashboard',
'owner.dashboard.exportPdf','owner.settings.roles.index','owner.settings.roles.update','owner.suppliers.index','owner.suppliers.create',
'owner.suppliers.store','owner.suppliers.show','owner.suppliers.edit','owner.suppliers.update','owner.suppliers.destroy',
'owner.expenses.index','owner.expenses.create','owner.expenses.store','owner.expenses.show','owner.expenses.edit',
'owner.expenses.update','owner.expenses.destroy','owner.assets.index','owner.assets.create','owner.assets.store',
'owner.assets.show','owner.assets.edit','owner.assets.update','owner.assets.destroy','owner.warranties.index',
'owner.warranties.create','owner.warranties.store','owner.warranties.show','owner.warranties.edit','owner.warranties.update',
'owner.warranties.destroy','owner.maintenances.index','owner.maintenances.create','owner.maintenances.store','owner.maintenances.show',
'owner.maintenances.edit','owner.maintenances.update','owner.maintenances.destroy','owner.stock.index','owner.stock.create',
'owner.stock.store','owner.stock.show','owner.stock.edit','owner.stock.update','owner.stock.destroy',
'owner.services.index','owner.services.create','owner.services.store','owner.services.show','owner.services.edit',
'owner.services.update','owner.services.destroy','owner.appointments.index','owner.appointments.create','owner.appointments.store',
'owner.appointments.edit','owner.appointments.update','owner.appointments.destroy','owner.invoices.index','owner.invoices.create',
'owner.invoices.store','owner.invoices.show','owner.invoices.edit','owner.invoices.update','owner.invoices.destroy',
'owner.invoice-items.destroy','owner.worktimes.index','owner.worktimes.create','owner.worktimes.store','owner.worktimes.show',
'owner.worktimes.edit','owner.worktimes.update','owner.worktimes.destroy','owner.api.worktime.resize','owner.api.worktime.move',
'owner.pages.index','owner.pages.create','owner.pages.store','owner.pages.show','owner.pages.edit',
'owner.pages.update','owner.pages.destroy','owner.galleries.index','owner.galleries.create','owner.galleries.store',
'owner.galleries.show','owner.galleries.edit','owner.galleries.update','owner.galleries.destroy','owner.design.edit',
'owner.design.update','owner.employees.index','owner.employees.create','owner.employees.store','owner.employees.show',
'owner.employees.edit','owner.employees.update','owner.employees.destroy','owner.users.index','owner.users.block',
'owner.users.unblock','owner.marketing.email.form','owner.marketing.email.send','owner.coupons.index','owner.coupons.create',
'owner.coupons.store','owner.coupons.destroy','owner.subscription.index','client.appointment.index','client.appointment.show',
'client.appointment.cancel','pwa.offline','pwa.manifest','register',
...
'app','emails.appointment_cancelled','emails.contact_message','emails.promo','owner.invoices.pdf',
'pdf.owner_appointments_pdf','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
